...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	runCalories := ((runningCaloriesMeanSpeedMultiplier * runningSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return runCalories
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	return ((walkingCaloriesWeightMultiplier*weight + (squareMeanSpeed/heightInM)*walkingSpeedHeightMultiplier*weight) * duration * minInH)
}
